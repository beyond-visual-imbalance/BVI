...
def load_langpair_dataset(
    ...
    for k in itertools.count():
        ...
        if split == 'train':
            ####################################Fashion-MMT##############################################
            # src_img_features = sorted(os.listdir('/Fashion-MMT-train'),key=lambda x: int(os.path.splitext(x)[0]))
            ...
            ####################################Fashion-MMT##############################################
            # src_img_features = sorted(os.listdir('/Fashion-MMT-valid'),key=lambda x: int(os.path.splitext(x)[0]))
            ###############################################################
